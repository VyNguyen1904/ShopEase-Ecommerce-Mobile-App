...
class AddressMapPreview extends StatelessWidget {
  ...
  Future<void> _handleMapTap(BuildContext context) async {
    ...
    if (selectedProvince != null && streetAddress.isNotEmpty) {
      final districtPart = selectedWard != null
          ? '${selectedWard['district_name']}, '
          : '';
      final wardPart = selectedWard != null ? '${selectedWard['name']}, ' : '';
      query =
          '$streetAddress, $wardPart$districtPart${selectedProvince['name']}';
    }
    ...
    if (result != null) {
      ...
      if (result['raw'] != null && result['raw']['address'] != null) {
        ...
        final displayName = (result['raw']['display_name']?.toString() ?? '')
            .toLowerCase();
  ...
  dynamic _findProvince(String displayName) {
    ...
    for (var p in provinces) {
      ...
      final pShort = pName
          .replaceFirst(RegExp(r'^(thành phố|tỉnh)\s+'), '')
          .trim();
      if (displayNameParts.contains(pName) ||
          displayNameParts.contains(pShort)) {
        return p;
      }
    }
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      latitude != null
                          ? AppStrings.tapToEditLocation
                          : AppStrings.tapToPinLocation,
