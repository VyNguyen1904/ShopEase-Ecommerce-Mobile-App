...
final List<NotificationItem> mockNotifications = [
  NotificationItem(
    ...
    content: 'Đơn hàng #SE2405150001 của bạn đã được giao thành công. Cảm ơn bạn đã mua sắm!',
    time: '10:30 AM',
    group: 'Hôm nay',
  ...
  NotificationItem(
    ...
    content: 'ShopEase Official: Cảm ơn bạn đã liên hệ! Chúng tôi sẽ hỗ trợ bạn sớm nhất.',
    time: '08:45 AM',
    group: 'Hôm nay',
