                    ...
                    child: Hero(
                      ...
                      child: Image.network(
                        ...
                        errorBuilder: (context, error, stackTrace) {
                          return const Icon(Icons.shopping_bag_outlined, color: AppColors.textGrey, size: 40);
                        },
                      ),
                    ),
                  ),
              ...
              child: ClipRRect(
                ...
                child: Hero(
                  ...
                  child: Image.network(
                    ...
                    fit: BoxFit.contain,
                    errorBuilder: (context, error, stackTrace) {
                      return const Icon(Icons.shopping_bag_outlined, color: AppColors.textGrey, size: 30);
                    },
                  ),
                ),
              ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: const Icon(Icons.favorite_border, size: 22, color: AppColors.textGrey),
                        onPressed: () {},
                      ),
                    ],
                  ),
