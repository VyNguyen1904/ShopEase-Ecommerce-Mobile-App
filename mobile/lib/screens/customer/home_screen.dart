      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              // 1. Search & Action Header (Matching Customer/5.png)
              Padding(
                ...
                child: Container(
                  ...
                  child: Stack(
                    children: [
                      ...
                      // Headphones graphic image overlay (matching layout)
                      Positioned(
                        right: 8,
                        bottom: 0,
                        top: 0,
              ...
              // 3. Quick Categories List (Matching Customer/5.png row)
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 16.0),
                child: Row(
              ...
              // 4b. Flash Sale Products Horizontal Row
              SizedBox(
                height: 170,
