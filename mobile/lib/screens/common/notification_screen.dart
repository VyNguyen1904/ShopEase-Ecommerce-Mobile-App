...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Group filtered notifications by 'group' (Hôm nay, Hôm qua, Trước đó)
    ...
    final sortedGroups = ['Hôm nay', 'Hôm qua', 'Trước đó'].where((g) => groupedNotifications.containsKey(g)).toList();
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            icon: const Icon(Icons.settings_outlined, color: AppColors.textDark, size: 24),
          ...
          Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // Count unread if Tất cả
                int? badgeCount;
                if (tab == 'Tất cả') {
                  badgeCount = mockNotifications.where((n) => n.isUnread).length;
                }
  ...
  Widget _buildNotificationTile(NotificationItem item) {
    ...
    switch (item.type) {
      case NotificationType.order:
        ...
        icon = item.title.contains('vận chuyển') ? Icons.local_shipping_outlined : Icons.inventory_2_outlined;
        break;
      ...
      case NotificationType.system:
        ...
        icon = item.title.contains('mừng') ? Icons.celebration_outlined : Icons.notifications_active_outlined;
        break;
    }
        ...
        child: InkWell(
          ...
          child: Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Icon Background (Pastel styled circles)
                Container(
                  width: 48,
                  height: 48,
                  decoration: BoxDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 13,
                          color: item.isUnread ? AppColors.textDark : AppColors.textGrey,
                          height: 1.3,
                        ),
                      ),
                    ],
