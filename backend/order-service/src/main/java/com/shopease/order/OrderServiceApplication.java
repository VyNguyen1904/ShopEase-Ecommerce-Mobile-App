        ...
        return args -> {
            if (orderRepository.count() == 0) {
                ...
                Order o1 = new Order(
                    ...
                    "COD", "Recipient 1", "+84900000001", "Street 1", "District 1", "City 1", "Note 1", now.minus(6, ChronoUnit.DAYS)
                );
                ...
                Order o2 = new Order(
                    ...
                    "Credit Card", "Recipient 2", "+84900000002", "Street 2", "District 2", "City 2", "Note 2", now.minus(5, ChronoUnit.DAYS)
                );
                ...
                Order o3 = new Order(
                    ...
                    "Credit Card", "Recipient 3", "+84900000003", "Street 3", "District 3", "City 3", "Note 3", now.minus(3, ChronoUnit.DAYS)
                );
                ...
                Order o4 = new Order(
                    ...
                    "COD", "Recipient 4", "+84900000004", "Street 4", "District 4", "City 4", "Note 4", now.minus(2, ChronoUnit.DAYS)
                );
                ...
                Order o5 = new Order(
                    ...
                    List.of(new OrderItem(1L, "Nike Air Max 270", "nike.jpg", new BigDecimal("160.00"), 1, new BigDecimal("160.00"), "seller-demo")),
                    new BigDecimal("160.00"), new BigDecimal("10.00"), BigDecimal.ZERO, new BigDecimal("170.00"),
                    "COD", "Recipient 5", "+84900000005", "Street 5", "District 5", "City 5", "Note 5", now.minus(1, ChronoUnit.DAYS)
                );
